...
Mention that you can see what the default Docusaurus example site gets you by running one of the in-browser sandboxes here: https://docusaurus.io/docs/playground

Mention the default plugins and the fact that others are available.

Then move into custom styling and how I adjusted things for my own site. Blog tags, removed authors, frontmatter, etc.

Link to the overall Docusaurus API.
