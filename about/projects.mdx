...
import OpenDIReactDecisionEngine from './assets/OpenDI-React-Decision-Engine.png';
...
<a class="zoomable" href={OpenDIReactDecisionEngine}><img decoding="async" loading="lazy" alt="OpenDI React Decision Engine" width="2149" height="834" class="img_ev3q" src={OpenDIReactDecisionEngine}/></a>
