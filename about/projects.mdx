...
> [Try it online!](https://opendi.org/cdd-authoring-tool/)  
...
- I specified [standard API endpoints](https://opendi.org/api-specification/api) for transmitting model JSON, using [OpenAPI 3.0](https://en.wikipedia.org/wiki/OpenAPI_Specification)
