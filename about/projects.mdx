...
I worked with one of the OpenDI co-founders, Dr. Roberts, on the [Coccidia Detection](#coccidia-detection) project, and he decided I'd be a good fit for helping them get this project started!

I have since contributed several solutions for a (mostly) web-based tech stack for OpenDI. I set up most of the organization's [GitHub repos](https://github.com/orgs/opendi-org/repositories?q=visibility%3Apublic+archived%3Afalse), and all of its public websites. They're all Docusaurus-based, serving markdown content via GitHub Pages [(seem familiar?)](/blog/how-my-site-works/).

Most of my work has gone into architecting standards for **interoperability**. DI practices align around the [concept of decision modeling](/blog/what-is-decision-intelligence). So _interoperability_ in this domain means being able to agree upon methods for storing and transmitting decision models and diagrams, and to define best practices, terminology, typical team members, roles and user stories, etc. The goal is to allow companies, researchers, and anyone else to _specialize_ their role in DI, naturally encouraging an ecosystem of many tools created by many parties.
...
- Contributed various documentation and other content to our public sites
...
- I combined the above two projects and a database in a [containerized](https://www.docker.com/) Docker Compose project [(repo)](https://github.com/opendi-org/containerized-authoring-demo), with Docker Hub images for the [authoring tool](https://hub.docker.com/repository/docker/iamkeldev/opendi-cdd-authoring-tool/general) and [api](https://hub.docker.com/repository/docker/iamkeldev/opendi-example-api-go/general)
