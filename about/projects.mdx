...
import OpenDIReactDecisionEngine from './assets/OpenDI_Authoring_Tool_April_2025.png';
...
<a class="zoomable" href={OpenDIReactDecisionEngine} target="_blank"><img decoding="async" loading="lazy" alt="OpenDI React Decision Engine" class="img_ev3q" src={OpenDIReactDecisionEngine}/></a>
...
> This version will be deployed sometime on **April 23, 2025**. [Try it here!](https://opendi.org/cdd-authoring-tool/)

I worked with one of the co-founders, Dr. Roberts, on the [Coccidia Detection](#coccidia-detection) project, and he decided I'd be a good fit for helping them get this project started!
...
The main bulk of my work, though, has been architecting standards for interoperability. DI practices align around the [concept of decision modeling](/blog/what-is-decision-intelligence). So _interoperability_ in this sort of framework means being able to agree upon methods for storing and transmitting these models and diagrams, and to settle ideas around best practices, terminology, typical team members, roles and user stories, etc.

Why is this useful? Interoperability allows companies, researchers, and anyone else to _specialize_ their role in DI, naturally encouraging an ecosystem of many tools created by many parties. The ideal situation is one where a simple decision diagram authored in one tool can be sent to another tool to have logical/simulation components attached, then connected to databases and simulated in yet another environment. Or a community could collaborate to build a model hub full of foundational decision models that can be freely extended in any toolset, adapted to more specific or complex contexts by experts, or used for research.
